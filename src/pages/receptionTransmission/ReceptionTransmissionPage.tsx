...
export const ReceptionTransmissionPage: React.FC = () => {
    ...
    const handleFormSubmit = (event: React.FormEvent) => {
        ...
        ReceptionTransmissionService.DeleteReceptionTransmission(modal.values)
            .then(() => {
    ...
    const tableList = ReceptionTransmissionService.GetReceptionTransmissionList(table.filter)
    ...
    return (
        <section>
            <ToastContainer/>
            <h1 className="text-[32px] font-bold">Прием / передача</h1>
